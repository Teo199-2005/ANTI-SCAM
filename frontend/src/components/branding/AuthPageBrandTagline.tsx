 ...
 */
export function AuthPageBrandTagline() {
  return (
    <div className="mt-6 flex items-center justify-center gap-2 border-t border-zinc-100/90 pt-5 text-center md:mt-4 md:pt-3">
